                ...
                <td>
                  <div class="d-flex justify-end align-center">
                    <v-btn
                      ...
                      elevation="3"
                      class="mr-3"
                      @click="(dialogEdit = true), (currentCompany = item)"
                      x-small
                      color="blue-grey"
                    >
                    ...
                    <v-btn
                      ...
                      dark
                      elevation="3"
                      @click="(dialogDelete = true), (companyId = item.id)"
                      x-small
                      color="red"
                    >
      ...
      <v-card>
       <v-card-title primary-title style="background-color:#85c9ff; font-size: 18px">
        ...
        <div class="d-flex justify-end py-3 pr-5">
          <v-btn color="primary" @click="deleteCompany" text>Đồng ý</v-btn>
...
export default {
  ...
  computed: {
    ...mapGetters("Company", ["listCompany"]),
  },
  methods: {
    convertDate(date) {
    ...
    deleteCompany(){
      this.$store.dispatch("Company/DeleteCompany", this.companyId);
